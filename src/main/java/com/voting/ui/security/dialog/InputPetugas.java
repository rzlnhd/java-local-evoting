...
import com.voting.ui.master.dialog.*;
...
public class InputPetugas extends javax.swing.JFrame {
    ...
    public InputPetugas(Admin a, int i){
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        initComponents();s=i;
        admin=a;initData(admin);// </editor-fold>        
    }
    ...
    private void initComponents() {
        ...
        setTitle(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.title")); // NOI18N
        setResizable(false);
        ...
        lTitle.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.lTitle.text")); // NOI18N

        pData.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.pData.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N

        lNama.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.lNama.text")); // NOI18N

        lUname.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.lUname.text")); // NOI18N

        lTPS.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.lTPS.text")); // NOI18N

        lType.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.lType.text")); // NOI18N

        fTps.setEditable(false);

        aType.add(rSU);
        rSU.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.rSU.text")); // NOI18N
        rSU.addActionListener(new java.awt.event.ActionListener() {
        ...
        aType.add(rReg);
        rReg.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.rReg.text")); // NOI18N
        ...
        aType.add(rOp);
        rOp.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.rOp.text")); // NOI18N
        rOp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cRad(evt);
            }
        });
        ...
        aType.add(rAu);
        rAu.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.rAu.text")); // NOI18N
        rAu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cRad(evt);
            }
        });
        ...
        sTps.setText("Pilih");
        sTps.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ePilih(evt);
            }
        });
        ...
        bSave.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.bSave.text")); // NOI18N
        ...
        bCancel.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.bCancel.text")); // NOI18N
        ...
        pFoto.setBorder(javax.swing.BorderFactory.createTitledBorder(null, org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.pFoto.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N
        ...
        bSearch.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.bSearch.text")); // NOI18N
        ...
        bCapture.setText(org.openide.util.NbBundle.getMessage(InputPetugas.class, "InputPetugas.bCapture.text")); // NOI18N
    ...
    private void wExit(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_wExit
        //<editor-fold defaultstate="collapsed" desc="Compiled Code">
        if(s==0){PetugasPanel.refresh();}else{MainUi.reload(c);}// </editor-fold>
    ...
    private void eCapture(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eCapture
        ...
        if(ca.getImage()!=null){image = ca.getImage();}
        bCapture.setEnabled(true);
        panelFoto1.setImage(image);//</editor-fold>
    }//GEN-LAST:event_eCapture

    private void cRad(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cRad
        setAcc();
    }//GEN-LAST:event_cRad
    ...
    private void initData(Admin a){
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        setTitle(s);fUname.setEditable(false);
        fUname.setText(a.getUsername());fNama.setText(a.getNama());
        if(a.getTpsCode()!=null){fTps.setText(a.getTpsCode().toString());}
        loadImage(a.getFoto());selectAcc(a.getAcc());editAcc(isEdited(s));        
        //</editor-fold>
    }
    ...
    private Admin setPetugas(){
        ...
        if(admin==null){
            ...
            admin.setFoto(foto);admin.setNama(fNama.getText());            
            if(s==0){admin.setAcc(acc);}
        }
        if(tps!=null){
    ...
    private void setTitle(int i){
        switch(i){
            case 0: lTitle.setText("Edit Petugas");
            default: lTitle.setText("Edit Profile");
        }
    }
    private void selectAcc(Acc ac){
        switch(ac.getId()){
            case "Auditor": rAu.setSelected(true);break;
            case "Operator": rOp.setSelected(true);break;
            case "Registrator": rReg.setSelected(true);break;
            default: rSU.setSelected(true);break;
        }
    }
    private void setAcc(){

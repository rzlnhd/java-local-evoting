...
public class RegistrasiPanel extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("RegistrasiPanel.title")); // NOI18N

        lTitle.setFont(new java.awt.Font("Futured", 1, 24)); // NOI18N
        lTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lTitle.setText(bundle.getString("RegistrasiPanel.lTitle.text")); // NOI18N
        ...
        if (tData.getColumnModel().getColumnCount() > 0) {
            ...
            tData.getColumnModel().getColumn(0).setHeaderValue(bundle.getString("RegistrasiPanel.tData.columnModel.title0")); // NOI18N
            tData.getColumnModel().getColumn(1).setMinWidth(150);
            tData.getColumnModel().getColumn(1).setMaxWidth(150);
            tData.getColumnModel().getColumn(1).setHeaderValue(bundle.getString("RegistrasiPanel.tData.columnModel.title1")); // NOI18N
            tData.getColumnModel().getColumn(2).setHeaderValue(bundle.getString("RegistrasiPanel.tData.columnModel.title2")); // NOI18N
            tData.getColumnModel().getColumn(3).setMinWidth(150);
            tData.getColumnModel().getColumn(3).setMaxWidth(150);
            tData.getColumnModel().getColumn(3).setHeaderValue(bundle.getString("RegistrasiPanel.tData.columnModel.title3")); // NOI18N
            tData.getColumnModel().getColumn(4).setMinWidth(150);
            tData.getColumnModel().getColumn(4).setMaxWidth(150);
            tData.getColumnModel().getColumn(4).setHeaderValue(bundle.getString("RegistrasiPanel.tData.columnModel.title4_1")); // NOI18N
        }
        ...
        lNik.setText(bundle.getString("RegistrasiPanel.lNik.text")); // NOI18N

        fNik.setText(bundle.getString("RegistrasiPanel.fNik.text")); // NOI18N
        fNik.addActionListener(e -> eCheck());

        rQr.setFont(new java.awt.Font("MS Gothic", 1, 18)); // NOI18N
        rQr.setText(bundle.getString("RegistrasiPanel.rQr.text")); // NOI18N
        rQr.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);

        btnBilik.setText(bundle.getString("RegistrasiPanel.btnBilik.text")); // NOI18N
        btnBilik.setEnabled(false);
        btnBilik.setVisible(false);
        btnBilik.addActionListener(e -> eKirim());

        btnCancel.setText(bundle.getString("RegistrasiPanel.btnCancel.text")); // NOI18N
        btnCancel.setEnabled(false);
        btnCancel.addActionListener(e -> eBatal());

        btnTunggu.setText(bundle.getString("RegistrasiPanel.btnTunggu.text")); // NOI18N
        btnTunggu.setEnabled(false);
        btnTunggu.setVisible(false);
        btnTunggu.addActionListener(e -> eTunggu());

        lNkk.setText(bundle.getString("RegistrasiPanel.lNkk.text")); // NOI18N

        lNama.setText(bundle.getString("RegistrasiPanel.lNama.text")); // NOI18N

        lTtl.setText(bundle.getString("RegistrasiPanel.lTtl.text")); // NOI18N

        lStat.setText(bundle.getString("RegistrasiPanel.lStat.text")); // NOI18N

        lAlamat.setText(bundle.getString("RegistrasiPanel.lAlamat.text")); // NOI18N

        lDukuh.setText(bundle.getString("RegistrasiPanel.lDukuh.text")); // NOI18N

        lRt.setText(bundle.getString("RegistrasiPanel.lRt.text")); // NOI18N

        lDif.setText(bundle.getString("RegistrasiPanel.lDif.text")); // NOI18N

        colom1.setText(bundle.getString("RegistrasiPanel.colom1.text")); // NOI18N

        colom2.setText(bundle.getString("RegistrasiPanel.colom2.text")); // NOI18N

        colom3.setText(bundle.getString("RegistrasiPanel.colom3.text")); // NOI18N

        colom4.setText(bundle.getString("RegistrasiPanel.colom4.text")); // NOI18N

        colom5.setText(bundle.getString("RegistrasiPanel.colom5.text")); // NOI18N

        colom6.setText(bundle.getString("RegistrasiPanel.colom6.text")); // NOI18N

        colom7.setText(bundle.getString("RegistrasiPanel.colom7.text")); // NOI18N

        fKk.setText(bundle.getString("RegistrasiPanel.fKk.text")); // NOI18N

        fNama.setText(bundle.getString("RegistrasiPanel.fNama.text")); // NOI18N

        fTtl.setText(bundle.getString("RegistrasiPanel.fTtl.text")); // NOI18N

        fStatus.setText(bundle.getString("RegistrasiPanel.fStatus.text")); // NOI18N

        fDukuh.setText(bundle.getString("RegistrasiPanel.fDukuh.text")); // NOI18N

        fRtRw.setText(bundle.getString("RegistrasiPanel.fRtRw.text")); // NOI18N

        fDif.setText(bundle.getString("RegistrasiPanel.fDif.text")); // NOI18N
        ...
        lTitle2.setText(bundle.getString("RegistrasiPanel.lTitle2.text")); // NOI18N

        btnExit.setText(bundle.getString("RegistrasiPanel.btnExit.text")); // NOI18N
        btnExit.addActionListener(e -> eExit());

        btnBatal.setText(bundle.getString("RegistrasiPanel.btnBatal.text")); // NOI18N
        btnBatal.setEnabled(false);
        btnBatal.addActionListener(e -> eCancel());
    ...
    private void eExit() {//GEN-FIRST:event_eExit
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        if (scan != null) {
            scan.doClose();
        }
    ...
    private void eCheck() {//GEN-FIRST:event_eCheck
        //<editor-fold defaultstate="collapsed" desc="Compiled Code">
    ...
    private void eBatal() {//GEN-FIRST:event_eBatal
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        image = null;
        setForm(false);
        scan.doClose();// </editor-fold>
    }//GEN-LAST:event_eBatal

    private void eKirim() {//GEN-FIRST:event_eKirim
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        bilik.setIdPemilih(p);
        p.setKet(3);
    ...
    private void eTunggu() {//GEN-FIRST:event_eTunggu
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        t = new Tunggu(p, tps);
        p.setKet(2);
        ts.waitingList(t, p);
    ...
    private void eCancel() {//GEN-FIRST:event_eCancel
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        tData.clearSelection();
        refresh();
        btnBatal.setEnabled(false);// </editor-fold>
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (code.length() != 0) {
                    ...
                    if (code.equals(induk)) {
                        rQr.setText("✔");
                        rQr.setForeground(new java.awt.Color(0, 153, 0));
                        setData(fNik.getText());
                        checkBilik();
                    } else {
                        rQr.setText("✖");
                        rQr.setForeground(new java.awt.Color(255, 0, 0));
                    }
                } else {
                    rQr.setVisible(false);
                    Check();
    ...
    private void setData(String s) {
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        p = ts.lookUpPemilih(s);
        setInfo(true);
        setFoto(p.getFoto());// </editor-fold>
    }
    ...
    private void setInfo(boolean b) {
        ...
        if (b) {
            ...
            fNama.setText(p.getNama() + " (" + setJk(p.getJenisKelamin()) + ")");
            fTtl.setText(p.getTLahir() + ", " + StringUtils.setTanggal(p.getTglLahir()) + " (" + p.getUmur() + " Tahun)");
            fStatus.setText(p.getStatusCode().toString());
            fDukuh.setText(p.getAlamat());
            fRtRw.setText(p.getRt() + "/" + p.getRw());
            fDif.setText(setDif(p.getDifableCode().toString()));
        } else {
            if (p != null) {
                p = null;
            }
    ...
    private void checkBilik() {
        ...
        if (!biliks.isEmpty()) {
            bilik = biliks.get(0);
            btnBilik.setText("Bilik No. " + bilik.getNo());
            tunggu(false);
        }
    ...
    private void tunggu(boolean b) {
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        if (t == null) {
            btnTunggu.setVisible(b);
            btnTunggu.setEnabled(b);
        } else {
            btnTunggu.setVisible(!b);
            btnTunggu.setEnabled(!b);
        }
        btnBilik.setVisible(!b);
        btnBilik.setEnabled(!b);// </editor-fold>
    }

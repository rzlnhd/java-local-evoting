...
public class InputPemilih extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("InputPemilih.title")); // NOI18N
        setResizable(false);
        ...
        lTitle.setText(bundle.getString("InputPemilih.lTitle.txt")); // NOI18N

        pData.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("InputPemilih.pData.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N

        lInduk.setText(bundle.getString("InputPemilih.lInduk.text")); // NOI18N

        lNama.setText(bundle.getString("InputPemilih.lNama.text")); // NOI18N

        lAlamat.setText(bundle.getString("InputPemilih.lAlamat.text")); // NOI18N

        buttonGroup1.add(rL);
        rL.setText(bundle.getString("InputPemilih.rL.text")); // NOI18N

        buttonGroup1.add(rP);
        rP.setText(bundle.getString("InputPemilih.rP.text")); // NOI18N

        lJenisK.setText(bundle.getString("InputPemilih.lJenisK.text")); // NOI18N
        ...
        lDisabilitas.setText(bundle.getString("InputPemilih.lDisabilitas.text")); // NOI18N

        lKk.setText(bundle.getString("InputPemilih.lKk.text")); // NOI18N

        lTlahir.setText(bundle.getString("InputPemilih.lTlahir.text")); // NOI18N

        lUmur.setText(bundle.getString("InputPemilih.lUmur.text")); // NOI18N

        fUmur.setEditable(false);
        fUmur.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        lDukuh.setText(bundle.getString("InputPemilih.lDukuh.text")); // NOI18N

        lRt.setText(bundle.getString("InputPemilih.lRt.text")); // NOI18N

        lRw.setText(bundle.getString("InputPemilih.lRw.text")); // NOI18N

        lStat.setText(bundle.getString("InputPemilih.lStat.text")); // NOI18N
        ...
        lLkl.setText(bundle.getString("InputPemilih.Lkll.text")); // NOI18N

        fTglLahir.addPropertyChangeListener(e -> age_calc());
        ...
        btnPilih.addActionListener(e -> ePilih());
        ...
        bSave.setText(bundle.getString("InputPemilih.bSave.text")); // NOI18N
        bSave.setToolTipText("Simpan");
        bSave.addActionListener(e -> eSave());

        bCancel.setText(bundle.getString("InputPemilih.bCancel.text")); // NOI18N
        bCancel.setToolTipText("Batal");
        bCancel.addActionListener(e -> dispose());

        pFoto.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("InputPemilih.pFoto.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N

        fFoto.setEditable(false);

        bCari.setText(bundle.getString("InputPemilih.bCari.text")); // NOI18N
        bCari.setToolTipText("Cari Foto");
        bCari.addActionListener(e -> cCari());

        bCapture.setText(bundle.getString("InputPemilih.bCapture.text")); // NOI18N
    ...
    private void initData(Pemilih p) {
        ...
        fInduk.setText(p.getInduk());
        fKk.setEditable(false);
        fInduk.setEditable(false);
        ...
        fTlahir.setText(p.getTLahir());
        fTglLahir.setDate(p.getTglLahir());
        fUmur.setText("" + p.getUmur() + "");
        fAlamat.setText(p.getAlamat());
        fRt.setText(p.getRt());
        fRw.setText(p.getRw());
        fLkl.setText(p.getIdLkl());
        loadTps(p.getTpsCode());
        loadImage(p.getFoto());
    ...
    private boolean isValidated() {
        ...
        if (Integer.parseInt(fUmur.getText()) <= 16 && b == true) {
            JOptionPane.showMessageDialog(this,

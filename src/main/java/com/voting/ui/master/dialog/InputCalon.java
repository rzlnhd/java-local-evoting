...
public class InputCalon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("InputCalon.title")); // NOI18N
        setResizable(false);
        ...
        lTitle.setText(bundle.getString("InputCalon.lTitle.text")); // NOI18N

        pData.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("InputCalon.pData.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N

        lInduk.setText(bundle.getString("InputCalon.lInduk.text")); // NOI18N

        lNama.setText(bundle.getString("InputCalon.lNama.text")); // NOI18N

        lJenisK.setText(bundle.getString("InputCalon.lJenisK.text")); // NOI18N

        lAlamat.setText(bundle.getString("InputCalon.lAlamat.text")); // NOI18N

        lAgama.setText(bundle.getString("InputCalon.lAgama.text")); // NOI18N

        buttonGroup1.add(rL);
        rL.setText(bundle.getString("InputCalon.rL.text")); // NOI18N

        buttonGroup1.add(rP);
        rP.setText(bundle.getString("InputCalon.rP.text")); // NOI18N
        ...
        lUrut.setText(bundle.getString("InputCalon.lUrut.text")); // NOI18N
        ...
        bSave.setText(bundle.getString("InputCalon.bSave.text")); // NOI18N
        bSave.addActionListener(e -> eSave());

        bCancel.setText(bundle.getString("InputCalon.bCancel.text")); // NOI18N
        bCancel.addActionListener(e -> dispose());

        pFoto.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("InputCalon.pFoto.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Futured", 1, 12))); // NOI18N
        ...
        bSearch.setText(bundle.getString("InputCalon.bSearch.text")); // NOI18N
        bSearch.setToolTipText("Type jpg|png|bmp");
        bSearch.addActionListener(e -> cCari());

        bCapture.setText(bundle.getString("InputCalon.bCapture.text")); // NOI18N
    ...
    private void initData(Calon c) {
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        fInduk.setText(c.getInduk());
        fUrut.setText("" + c.getId());
        fInduk.setEditable(false);
        fUrut.setEditable(false);
        fNama.setText(c.getNama());
        fAlamat.setText(c.getAlamat());
        if (c.getJenisKelamin().equalsIgnoreCase("L")) {
            rL.setSelected(true);
        } else {
            rP.setSelected(true);
        }
        cAgama.setSelectedItem(c.getAgama());
        loadImage(c.getFoto());
    ...
    private Calon setCalon() {
        ...
        if (calon == null) {
            return new Calon(fInduk.getText(), fNama.getText(), fAlamat.getText(), jk,
                    (String) cAgama.getSelectedItem(), Integer.valueOf(fUrut.getText()), foto);
        } else {
            calon.setNama(fNama.getText());
            calon.setJenisKelamin(jk);
            calon.setAlamat(fAlamat.getText());
            calon.setFoto(foto);

...
public class PemilihPanel extends javax.swing.JInternalFrame {
    ...
    private void initListener() {
        ...
        panelTombol1.getBtnDelete().addActionListener((ActionEvent e) -> {
            ...
            if (Pilih == JOptionPane.YES_OPTION) {
                ms.deletePemilih(pemilih);
                UploadImg.deletePhoto(pemilih.getFoto());
                refresh();
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("PemilihPanel.title")); // NOI18N

        lTitle.setFont(new java.awt.Font("Futured", 1, 24)); // NOI18N
        lTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lTitle.setText(bundle.getString("PemilihPanel.lTitle.text")); // NOI18N
        ...
        if (tData.getColumnModel().getColumnCount() > 0) {
            ...
            tData.getColumnModel().getColumn(0).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title13")); // NOI18N
            tData.getColumnModel().getColumn(1).setMinWidth(150);
            tData.getColumnModel().getColumn(1).setMaxWidth(150);
            tData.getColumnModel().getColumn(1).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title0")); // NOI18N
            tData.getColumnModel().getColumn(2).setMinWidth(150);
            tData.getColumnModel().getColumn(2).setMaxWidth(150);
            tData.getColumnModel().getColumn(2).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title1")); // NOI18N
            tData.getColumnModel().getColumn(3).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title2")); // NOI18N
            tData.getColumnModel().getColumn(4).setMinWidth(100);
            tData.getColumnModel().getColumn(4).setMaxWidth(250);
            tData.getColumnModel().getColumn(4).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title3")); // NOI18N
            tData.getColumnModel().getColumn(5).setMinWidth(100);
            tData.getColumnModel().getColumn(5).setMaxWidth(250);
            tData.getColumnModel().getColumn(5).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title4")); // NOI18N
            tData.getColumnModel().getColumn(6).setMaxWidth(45);
            tData.getColumnModel().getColumn(6).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title10")); // NOI18N
            tData.getColumnModel().getColumn(7).setMinWidth(120);
            tData.getColumnModel().getColumn(7).setMaxWidth(120);
            tData.getColumnModel().getColumn(7).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title5")); // NOI18N
            tData.getColumnModel().getColumn(8).setMaxWidth(70);
            tData.getColumnModel().getColumn(8).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title6")); // NOI18N
            tData.getColumnModel().getColumn(9).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title7")); // NOI18N
            tData.getColumnModel().getColumn(10).setMaxWidth(35);
            tData.getColumnModel().getColumn(10).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title8")); // NOI18N
            tData.getColumnModel().getColumn(11).setMaxWidth(35);
            tData.getColumnModel().getColumn(11).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title9")); // NOI18N
            tData.getColumnModel().getColumn(12).setMinWidth(100);
            tData.getColumnModel().getColumn(12).setMaxWidth(100);
            tData.getColumnModel().getColumn(12).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title11")); // NOI18N
            tData.getColumnModel().getColumn(13).setMaxWidth(60);
            tData.getColumnModel().getColumn(13).setHeaderValue(bundle.getString("PemilihPanel.tData.columnModel.title12")); // NOI18N
        }
        ...
        bRefresh.setText(bundle.getString("PemilihPanel.bRefresh.text")); // NOI18N

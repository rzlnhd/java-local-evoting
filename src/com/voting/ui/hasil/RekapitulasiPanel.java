...
public class RekapitulasiPanel extends javax.swing.JInternalFrame {
    ...
    public RekapitulasiPanel() {
        initComponents();initListener();loadData();createChart(calons);
    }
    
    private void initListener() {
        // <editor-fold defaultstate="collapsed" desc="Compiled Code">
        panelTombol1.invis();panelTombol1.getBtnNew().setText("Print");
    ...
    private static class CalonModel extends AbstractTableModel{
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch(columnIndex){
                ...
                case 1 : return setImage(c.getFoto());
                case 2 : return c.getNama();
                case 3 : return c.getSuara();
                case 4 : return c.getSuara()*100/count+" %";
                default : return "";
            }
        }// </editor-fold>
    }
    ...
    private void initComponents() {
        ...
        calons = MainUi.getMasterService().getAllCalon();
        pChart = new XChartPanel<PieChart>(createChart(calons));
        jScrollPane2 = new javax.swing.JScrollPane();
        tData_2 = new javax.swing.JTable();

        setTitle(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.title")); // NOI18N

        lTitle.setFont(new java.awt.Font("Futured", 1, 24)); // NOI18N
        lTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lTitle.setText(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.lTitle.text")); // NOI18N
        ...
        if (tData.getColumnModel().getColumnCount() > 0) {
            ...
            tData.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData.columnModel.title0")); // NOI18N
            tData.getColumnModel().getColumn(1).setMinWidth(90);
            tData.getColumnModel().getColumn(1).setMaxWidth(90);
            tData.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData.columnModel.title1")); // NOI18N
            tData.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData.columnModel.title2")); // NOI18N
            tData.getColumnModel().getColumn(3).setMinWidth(80);
            tData.getColumnModel().getColumn(3).setMaxWidth(80);
            tData.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData.columnModel.title3")); // NOI18N
            tData.getColumnModel().getColumn(4).setMinWidth(80);
            tData.getColumnModel().getColumn(4).setMaxWidth(80);
            tData.getColumnModel().getColumn(4).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData.columnModel.title4")); // NOI18N
        }
        ...
        if (tData_2.getColumnModel().getColumnCount() > 0) {
            tData_2.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData_2.columnModel.title0")); // NOI18N
            tData_2.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData_2.columnModel.title1")); // NOI18N
            tData_2.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData_2.columnModel.title2")); // NOI18N
            tData_2.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(RekapitulasiPanel.class, "RekapitulasiPanel.tData_2.columnModel.title3")); // NOI18N
        }
